 ...
 */
export declare const GoldenLayoutComponents: InjectionToken<ComponentType[]>;
/**
 * Inject dependency modules to be used with the PluginRegistry
 * This token can use multi: true
 */
export declare const GoldenLayoutPluginDependency: InjectionToken<PluginDependencyType[]>;
