...
/** @nocollapse */
PluginURLProvider.ɵfac = function PluginURLProvider_Factory(t) { return new (t || PluginURLProvider)(); };
/** @nocollapse */
PluginURLProvider.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PluginURLProvider, factory: function (t) { return PluginURLProvider.ɵfac(t); } });
PluginURLProvider = __decorate([
    MultiWindowService('_gl__PluginURLProvider')
], PluginURLProvider);
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PluginURLProvider, [{
        type: Injectable
...
/** @nocollapse */
MockPluginRegistryService.ɵfac = function MockPluginRegistryService_Factory(t) { return new (t || MockPluginRegistryService)(); };
/** @nocollapse */
MockPluginRegistryService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MockPluginRegistryService, factory: MockPluginRegistryService.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MockPluginRegistryService, [{
        type: Injectable
    }], function () { return []; }, null); })();
/**
...
/** @nocollapse */
PluginRegistryService.ɵfac = function PluginRegistryService_Factory(t) { return new (t || PluginRegistryService)(ɵngcc0.ɵɵinject(GoldenLayoutPluginDependency, 8), ɵngcc0.ɵɵinject(PluginURLProvider), ɵngcc0.ɵɵinject(ɵngcc0.Injector)); };
/** @nocollapse */
PluginRegistryService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PluginRegistryService, factory: PluginRegistryService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PluginRegistryService, [{
        type: Injectable
    }], function () { return [{ type: Array, decorators: [{
                type: Inject,
                args: [GoldenLayoutPluginDependency]
            }, {
                type: Optional
            }] }, { type: PluginURLProvider }, { type: ɵngcc0.Injector }]; }, null); })();
...
/** @nocollapse */
WrapperComponent.ɵfac = function WrapperComponent_Factory(t) { return new (t || WrapperComponent)(ɵngcc0.ɵɵdirectiveInject(GoldenLayoutComponentHost), ɵngcc0.ɵɵdirectiveInject(GoldenLayoutContainer), ɵngcc0.ɵɵdirectiveInject(GoldenLayoutComponentState)); };
/** @nocollapse */
WrapperComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: WrapperComponent, selectors: [["gl-wrapper"]], decls: 1, vars: 0, consts: [[1, "wrapper"]], template: function WrapperComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(WrapperComponent, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [GoldenLayoutComponentHost]
            }] }, { type: undefined, decorators: [{
                type: Inject,
                args: [GoldenLayoutContainer]
            }] }, { type: undefined, decorators: [{
                type: Inject,
                args: [GoldenLayoutComponentState]
            }] }]; }, null); })();
...
/** @nocollapse */
ComponentRegistryService.ɵfac = function ComponentRegistryService_Factory(t) { return new (t || ComponentRegistryService)(ɵngcc0.ɵɵinject(GoldenLayoutComponents, 8), ɵngcc0.ɵɵinject(PluginRegistryService, 8)); };
/** @nocollapse */
ComponentRegistryService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ComponentRegistryService, factory: ComponentRegistryService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ComponentRegistryService, [{
        type: Injectable
    }], function () { return [{ type: Array, decorators: [{
                type: Inject,
                args: [GoldenLayoutComponents]
            }, {
                type: Optional
            }] }, { type: PluginRegistryService, decorators: [{
                type: Optional
            }] }]; }, null); })();
...
/** @nocollapse */
RootWindowService.ɵfac = function RootWindowService_Factory(t) { return new (t || RootWindowService)(); };
/** @nocollapse */
RootWindowService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RootWindowService, factory: RootWindowService.ɵfac });
RootWindowService.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RootWindowService, [{
        type: Injectable
    }], function () { return []; }, null); })();
...
/** @nocollapse */
MockWindowSynchronizerService.ɵfac = function MockWindowSynchronizerService_Factory(t) { return new (t || MockWindowSynchronizerService)(); };
/** @nocollapse */
MockWindowSynchronizerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MockWindowSynchronizerService, factory: MockWindowSynchronizerService.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MockWindowSynchronizerService, [{
        type: Injectable
    }], null, null); })();
...
/** @nocollapse */
WindowSynchronizerService.ɵfac = function WindowSynchronizerService_Factory(t) { return new (t || WindowSynchronizerService)(ɵngcc0.ɵɵinject(ɵngcc0.ApplicationRef), ɵngcc0.ɵɵinject(RootWindowService), ɵngcc0.ɵɵinject(ɵngcc0.Injector)); };
/** @nocollapse */
WindowSynchronizerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: WindowSynchronizerService, factory: WindowSynchronizerService.ɵfac });
WindowSynchronizerService.ctorParameters = () => [
    { type: ApplicationRef },
    { type: RootWindowService },
    { type: Injector }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(WindowSynchronizerService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc0.ApplicationRef }, { type: RootWindowService }, { type: ɵngcc0.Injector }]; }, null); })();
...
/** @nocollapse */
GoldenLayoutComponent.ɵfac = function GoldenLayoutComponent_Factory(t) { return new (t || GoldenLayoutComponent)(ɵngcc0.ɵɵdirectiveInject(RootWindowService), ɵngcc0.ɵɵdirectiveInject(ComponentRegistryService), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Injector), ɵngcc0.ɵɵdirectiveInject(WindowSynchronizerService), ɵngcc0.ɵɵdirectiveInject(GoldenLayoutComponent, 12), ɵngcc0.ɵɵdirectiveInject(FallbackComponent, 8)); };
/** @nocollapse */
GoldenLayoutComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: GoldenLayoutComponent, selectors: [["golden-layout-root"]], viewQuery: function GoldenLayoutComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 3);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.el = _t.first);
    } }, hostBindings: function GoldenLayoutComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("resize", function GoldenLayoutComponent_resize_HostBindingHandler() { return ctx.onResize(); }, false, ɵngcc0.ɵɵresolveWindow)("beforeunload", function GoldenLayoutComponent_beforeunload_HostBindingHandler() { return ctx.beforeUnload(); }, false, ɵngcc0.ɵɵresolveWindow)("pagehide", function GoldenLayoutComponent_pagehide_HostBindingHandler() { return ctx.pageHide(); }, false, ɵngcc0.ɵɵresolveWindow);
    } }, inputs: { layout: "layout" }, outputs: { stateChanged: "stateChanged", tabActivated: "tabActivated" }, decls: 2, vars: 0, consts: [[1, "ng-golden-layout-root"], ["glroot", ""]], template: function GoldenLayoutComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", 0, 1);
    } }, styles: [".ng-golden-layout-root[_ngcontent-%COMP%] {\n      width:100%;\n      height:100%;\n    }"] });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(GoldenLayoutComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: RootWindowService }, { type: ComponentRegistryService }, { type: ɵngcc0.ViewContainerRef }, { type: ɵngcc0.ComponentFactoryResolver }, { type: ɵngcc0.NgZone }, { type: ɵngcc0.Injector }, { type: WindowSynchronizerService }, { type: GoldenLayoutComponent, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            }] }, { type: undefined, decorators: [{
...
/** @nocollapse */
GoldenLayoutModule.ɵfac = function GoldenLayoutModule_Factory(t) { return new (t || GoldenLayoutModule)(); };
/** @nocollapse */
GoldenLayoutModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: GoldenLayoutModule });
/** @nocollapse */
GoldenLayoutModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(GoldenLayoutModule, { declarations: function () { return [GoldenLayoutComponent, WrapperComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [GoldenLayoutComponent]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(GoldenLayoutModule, [{
        type: NgModule,
        args: [{
